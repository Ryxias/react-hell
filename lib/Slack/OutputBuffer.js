...
class OutputBuffer {
   ...
   */
  constructor(slackbot, original_message) {
    this.sendMessage = slackbot.sendMessage.bind(slackbot);
    this.addReaction = slackbot.addReaction.bind(slackbot);
  ...
  react(emote) {
    return this.addReaction(emote, this.original_message);
  }
