...
const FOUNDATION = {
  ability_score: function(string) {
    const score = string.toUpperCase();
    if (score in this.ABILITY_SCORES) {
      return this.ABILITY_SCORES[score];
    }
    throw new Error(`No such ability score: ${string}`);
  },
  ABILITY_SCORES: {
...
{
  // registry.register(ACCUMULATION.SAVES.FORTITUDE, {
  //
  // });
}
