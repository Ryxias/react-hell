...
// Register HP related stuff
{
  registry.register(FOUN_HP_ROLLS, {
    ...
    dependencies: [ FOUNDATION.CLASS_LEVELS, FOUN_RACE_LV ],
  });
  registry.register(FOUN_HD, {
    script: data => {
      return (data[FOUNDATION.CLASS_LEVELS] ? data[FOUNDATION.CLASS_LEVELS].length : 0) +
...
// Derive Adjustment Aggregates
{
  const buildAbilityScoreAdjustmentAggregatorModel = function(stat) {
    ...
    function addEntry(from, stat, type, value) {
      return { from: from, stat: stat, type: type, value: value };
    }
  };
