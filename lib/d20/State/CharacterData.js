    ...
    'foundation:class_levels': [
      {
        ...
        hp_roll: 10,
        adjustments: [
          { stat: 'fortitude_save', value: 2, type: 'no_type:class:fighter1' },
          { stat: 'base_attack_bonus', value: 1, type: 'no_type:class:fighter1' },
          { stat: 'hp_roll', value: 10, type: 'no_type:class:fighter1' },
        ],
        class_skills: [
          'climb', 'jump', 'swim',
        ],
        skill_ranks: {
          climb: 1, stealth: 1, profession_tailor: 1,
        }
      },
      {
        name: 'fighter2',
    ...
    'foundation:racial_levels': [
      {
        ...
        hp_roll: 2,
        adjustments: [
          { stat: 'reflex_save', value: 1, type: 'no_type:race:elin1' }, // Racial LEVELS do not grant racial BONUSES
          { stat: 'will_save', value: 1, type: 'no_type:race:elin1' },
          { stat: 'hp_roll', value: 7, type: 'no_type:race:elin1' },
        ],
      },
    ],
