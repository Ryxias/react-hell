...
// Configuration
const SLACK_BOT_TOKEN = 'xoxb-235188197473-WRO1iyGdJkPUElrfGitFLoyd'; // Probably a bad idea to keep in the public domain but we can re-generate it
...
const chuu = new Chuubot(SLACK_BOT_TOKEN, CHUUBOT_USER_ID, VERBOSE);
chuu.connect();
