...
// Configuration
const SLACK_BOT_TOKEN = config.slack.bot_token; // Probably a bad idea to keep in the public domain but we can re-generate it
const CHUUBOT_USER_ID = config.slack.bot_user_id;
const VERBOSE = false;
