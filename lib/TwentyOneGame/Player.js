    ...
    return this.engine.playerStay(this)
      ...
      .then(next_player_turn => {
        ...
        if (this.engine.game_state.isGameOver()) {
          ...
          return this.output.notifyStayThenGameIsOver();

        } else if (this.engine.game_state.isRoundOver()) {
          let game_results = this.engine.gameResults();
          let deck = this.engine.game_state.getDeck();
          let player_hands = getPlayerHands(this.engine, game_results.winner);

          return this.output.notifyStayThenRoundIsOver(game_results, player_hands, deck);
        } else {
