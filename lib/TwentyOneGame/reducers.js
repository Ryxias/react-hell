...
function gameInitializationReducer(game_state, action) {
  switch (action.type) {
    case ActionTypes.next_round: {
      ...
      // The player to go first is the loser of the previous round
  ...
  switch (action.type) {
    ...
    case ActionTypes.player_stay:
      if (game_state.allPlayersStayed()) {
        ...
        game_state.game_over = true; // FIXME this is not true!
        ...
        // FIXME, if a player has lost, we create a new player LOSE event?
      }
      break;
  }
}
